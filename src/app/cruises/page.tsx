    ...
    <main className="flex flex-1 flex-col bg-background">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-10 sm:py-12">
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-lg font-semibold text-foreground">Departure Ports</h2>
          <p className="text-sm text-muted-foreground">Click a port to see cruises departing from there</p>
        </div>
        <CruiseMap />
      </section>
